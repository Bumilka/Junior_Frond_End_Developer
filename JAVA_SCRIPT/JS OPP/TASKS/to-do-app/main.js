...
// //metoda - optymalizująca , odwołanie się do imputu, też definiujemy js
// // wywołanie funckji natychmiastowej
...
//     // operację odwołujądę się do DOMU są kosztownymi operacjami, bo to jest podróżowanie po całym DOM 
...
// // wywołanie funckji natychmiastowej
    ...
    this.addTaskToDo = this.addTaskToDo.bind(this) // przypisujemy na stałe kontekst wywołania metody do obiektu naszej aplikacji
    this.moveTaskToDone = this.moveTaskToDone.bind(this) // przypisujemy na stałe kontekst wywołania metody do obiektu naszej aplikacji
    this.removeTaskToDo = this.removeTaskToDo.bind(this) // przypisujemy na stałe kontekst wywołania metody do obiektu naszej aplikacji
}
    renderUI(){
        const appContainer = document.querySelector('#toDoAppContainer'); // pobieramy nasz div z htmla po ID w celu wstawienia w niego naszego UI
        appContainer.appendChild(this.inputNode); // <- wstawiamy nasze pole tekstowe
